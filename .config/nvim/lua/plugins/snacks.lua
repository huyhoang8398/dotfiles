...
function Plugin.config(_, opts)
  ...
  vim.keymap.set('n', '<leader>fb', '<cmd>lua Snacks.picker("buffers")<cr>', {desc = 'Search open files'})
  vim.keymap.set('n', '<leader>\\', '<cmd>lua Snacks.picker("files")<cr>', {desc = 'Search all files'})
  vim.keymap.set('n', '<leader>fh', '<cmd>lua Snacks.picker("recent")<cr>', {desc = 'Search file history'})
  vim.keymap.set('n', '<leader>fw', '<cmd>lua Snacks.picker("grep")<cr>', {desc = 'Search in project'})
  vim.keymap.set('n', '<leader>fd', '<cmd>lua Snacks.picker("diagnostics")<cr>', {desc = 'Search diagnostics'})
  vim.keymap.set('n', '<leader>fz', '<cmd>lua Snacks.picker("lines")<cr>', {desc = 'Buffer local search'})
